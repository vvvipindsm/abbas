...
<head>
	...
	<title>Accordion Shortcode | Enar</title>
...
<div id="main_wrapper">
					...
					<div id="nav_menu">
						...
						<ul id="navy" class="clearfix">
							...
							<li class="normal_menu mobile_menu_toggle">
								...
								<ul>
									<li class="normal_menu"><a href="shop.html">Default Shop</a></li>
									<li class="normal_menu"><a href="shop-item.html">Shop Single Product</a></li>
									<li class="normal_menu"><a href="shop-check-out.html">Shop Check Out</a></li>
									<li class="normal_menu"><a href="#"><span class="menu_special_color">More Pages Soon ...</span></a></li>
								</ul>
							</li>
							<li class="has_image_menu mobile_menu_toggle">
								<a href="page-team-members.html"><span>Team</span></a>
								<ul class="image_menu">													<li class="image_menu_slide">
										<div class="img_menu_i">
	...
	<section class="content_section bg_white">
		<div class="content row_spacer clearfix">
			<div class="col-md-6">
				...
				<div class="enar_accordion plus_minus" data-type="accordion"> <!-- accordion - toggle -->
					...
					<div class="enar_occ_container" data-expanded="false">
						<span class="enar_occ_title">HTML5</span>
						<div class="enar_occ_content">
							<div class="acc_content">
							Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
							</div>
					...
					<div class="enar_occ_container" data-expanded="false">
						<span class="enar_occ_title">Graphic Design</span>
						<div class="enar_occ_content">
							<div class="acc_content">
							Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
							</div>
			...
			<div class="col-md-6">
				<div class="main_title upper small">
					<h2><span class="line"><span class="dot"></span></span>Toggle Style</h2>
				</div>
				<!-- My Accordion -->
	...
	<section class="content_section bg_gray">
		<div class="content row_spacer clearfix">
			<div class="col-md-12">
				<div class="main_title upper small">
					<h2><span class="line"><span class="dot"></span></span>Accordion With Icons</h2>
				</div>
				<!-- Accordion -->
					...
					<div class="panel panel-default">
						<div class="panel-heading" role="tab" id="headingOne3">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne3" aria-expanded="true" aria-controls="collapseOne"><i class="ico-open"></i>Web Design
						...
						<div class="panel-heading" role="tab" id="headingThree3">
							<h4 class="panel-title">
								<a class="collapsed" data-toggle="collapse" data-parent="#accordion3" href="#collapseThree3" aria-expanded="false" aria-controls="collapseThree3">
									<i class="ico-location3"></i>Graphic Design
								</a>
							</h4>
						</div>
			...
			<div class="rows_container clearfix">
				<div class="col-md-3">
					<div class="footer_row">
						...
						<img alt="Enar Theme" src="images/logo-light.png">
				...
				<div class="col-md-3">
					<div class="footer_row">
						...
						<ul class="recent_posts_list">
							<li class="clearfix">
								<a href="#">
									<span class="recent_posts_img"><img src="images/blog/thumb1.jpg" alt="Post Title"></span>
							...
							<li class="clearfix">
								<a href="#">
									<span class="recent_posts_img"><img src="images/blog/thumb2.jpg" alt="Post Title"></span>
							...
							<li class="clearfix">
								<a href="#">
									<span class="recent_posts_img"><img src="images/blog/thumb3.jpg" alt="Post Title"></span>
							...
							<li class="clearfix">
								<a href="#">
									<span class="recent_posts_img"><img src="images/blog/thumb4.jpg" alt="Post Title"></span>
									<span>Best HTML5 Theme</span>
								</a>
								<span class="recent_post_detail">2015/01/23</span>
								<span class="recent_post_detail">Tutorials, Videos</span> 
				...
				<div class="col-md-3">
					<div class="footer_row">
						...
						<div class="about_author clearfix">
							<a href="#" class="about_author_link">
								<img src="images/clients/team2-medium.jpg" alt="Author Name">
								<span>John Doe</span>
							</a>
					...
					<div class="footer_row">
						...
						<a class="hm_vid_con popup-vimeo" href="http://vimeo.com/29193046">
							...
							<img alt="Video Title" src="images/blog/blog5.jpg">
						</a>
					</div>
				</div><!-- Grid -->
			</div>
